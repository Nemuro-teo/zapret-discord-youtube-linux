...
zapret-cli status
```
Выводит название активной стратегии, состояние игрового фильтра и системный статус службы.

### 5. Обновление списков доменов и IP
```bash
